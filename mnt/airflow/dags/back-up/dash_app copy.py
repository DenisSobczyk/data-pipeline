...
def test():
    ...
    df_nasdaq = pd.read_csv('/opt/airflow/dags/data/^IXIC_data_yahoo.csv')
    df_sp500 = pd.read_csv('/opt/airflow/dags/data/^GSPC_data_yahoo.csv')
    df_coca_cola = pd.read_csv('/opt/airflow/dags/data/KO_data_yahoo.csv')
    df_nvidia = pd.read_csv('/opt/airflow/dags/data/NVDA_data_yahoo.csv')
    df_gold = pd.read_csv('/opt/airflow/dags/data/GC=F_data_yahoo.csv')
